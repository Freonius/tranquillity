...
setup(name='tranquillity.exceptions', version=_version, packages=find_packages(exclude=['test', ],), install_requires=reqs,
      author='Federico Pirani',
      description='Tranquillity exceptions.', long_description=ld,
