...
setup(name='tranquillity.schedulable', version=_version, packages=find_packages(exclude=['test', ],), install_requires=reqs,
      author='Federico Pirani',
      description='Tranquillity schedulable.', long_description=ld,
